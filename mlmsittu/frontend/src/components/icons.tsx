...
/**
 * A small line-icon set for navigation and stat tiles.
 *
 * Drawn inline rather than pulled from an icon package: the app needs about twenty glyphs, and a
 * dependency for twenty paths is a poor trade. The shapes follow the Lucide conventions — a 24px
 * grid, 2px round-capped strokes, no fills — so they sit together as one family.
 *
 * Always decorative. Every icon here appears beside a text label, so each is `aria-hidden` and
 * nothing depends on it being seen.
 */
const glyphs = {
  dashboard: (
    <>
